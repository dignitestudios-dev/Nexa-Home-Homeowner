...
const ServiceDetails = () => {
  ...
  console.log("🚀 ~ ServiceDetails ~ params:", params);
  return (
    <div className="max-w-[1400px] mx-auto rounded-[24px] py-2 ">
      ...
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-[32px] font-semibold">Service Details</h1>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_487px] gap-6">
          ...
          <div className="bg-[#F9FAFA] rounded-[18px] p-6 lg:p-8">
            <div className="space-y-4">
              ...
              <p className="text-base leading-[26px] text-[rgba(24,24,24,0.6)]">
                ...
                aliquet eu. Lorem ipsum dolor sit amet consectetur. Lorem ipsum
                dolor sit amet consectetur. Diam aliquet lectus laoreet enim
                faucibus vitae facilisi. Quis amet imperdiet ut molestie luctus
                risus lacinia. Mauris vel mus at urna vulputate aliquet eu.
              </p>
            </div>
          </div>
            ...
            <div className="flex items-start justify-between gap-6 flex-col sm:flex-row">
              <div>
                ...
                <div className="space-y-2">
                  <p className="text-base font-medium text-[#282828]">Office</p>
        ...
        {/* RIGHT SIDEBAR */}
        <div className="bg-[#F9FAFA] rounded-[18px] p-6 flex flex-col h-80">
          ...
          <div className="space-y-4 flex-1">
            {experts.map((expert, index) => (
              <div
                key={index}
                className=" shadow-sm rounded-xl p-4 transition hover:shadow-sm"
              >
          ...
          {params.id === "123" ? (
            <div className="mt-8 flex-1">
              {/* CTA */}
              <Button className="h-12 w-full rounded-xl bg-[#005864] hover:bg-[#004752] text-white text-base font-semibold">
                Mark As Completed
              </Button>
            </div>
          ) : (
